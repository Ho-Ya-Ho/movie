...
function Movie({ id, rating, coverImg, title, year, summary, genres, movie_style }) {
    if (coverImg === "") {
        return null;
    }
    return (
        <div className={styles.movie} style={movie_style}>
            ...
            <div>
                ...
                <h3 className={styles.movie__year}>year : {year}</h3>
                <h3 className={styles.movie__year}>rating : {rating}</h3>
